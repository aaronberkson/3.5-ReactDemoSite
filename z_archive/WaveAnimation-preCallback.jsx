...
const GRAD_PERCENT_SEG0 = 45; // Percentage for Blue → Purple
const GRAD_PERCENT_SEG1 = 15; // Percentage for Purple → Pink
const GRAD_PERCENT_SEG2 = 15; // Percentage for Pink → Orange
