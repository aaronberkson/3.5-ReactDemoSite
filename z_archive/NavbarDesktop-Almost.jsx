...
// Animation Variants for Line 1 and Line 2
...
const NavbarDesktop = ({ startAnimation }) => {
  ...
  // Dynamic Font Sizing for Line 2 using helper functions.
  useLayoutEffect(() => {
    const recalcLine2 = () => {
      if (textContainerRef.current) {
        const availableWidth = textContainerRef.current.clientWidth;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Line 1 Container: Absolutely positioned at the top (no extra offset) */}
          <div
            style={{
              position: "absolute",
              top: 0,
          ...
          {/* Line 2 Container: Absolutely positioned directly below line 1 */}
          <div
            style={{
              position: "absolute",
        ...
        >
          <NavIconsDesktop
            ...
            onCMUClick={() =>
              window.open("https://csd.cmu.edu/", "_blank")
            }
